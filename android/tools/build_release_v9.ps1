...
& $gradle --no-daemon --console=plain assembleRelease bundleRelease
...
$out = Join-Path $project 'release-v9'
New-Item -ItemType Directory -Force -Path $out | Out-Null
$apk = Join-Path $out 'Dastyar-Vakil-v9.0.0-release.apk'
...
$bundle = Join-Path $out 'Dastyar-Vakil-v9.0.0-release.aab'
